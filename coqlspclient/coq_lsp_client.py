...
class CoqLspClient(LspClient):
    def __init__(self, root_uri: str, prog_bar: ProgressBar = AliveProgressBar()) -> None:
    ...
    def didOpen(self, textDocument: TextDocumentItem) -> None:
        ...
        self.prog_bar.initialize(amount_lines)
        while timeout > 0:
            if self.lsp_endpoint.completed_operation:
                ...
                self.prog_bar.update_count(cur_process_line)
